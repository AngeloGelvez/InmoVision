  ...
  <body class="d-flex">
    ...
    <div class="container mt-5">
      <aside class="d-flex" style="justify-content:space-between;">
        <h3>Registros</h3>
        <a href="./create-user.jsp" class="btn btn-icon btn-sm btn-success">
            ...
            <%
              ...
              try{
                ...
                while(result.next()) {
                  ...
                  out.println("<td>"+result.getInt("cliente_id")+"</td>");
                  out.println("<td>"+result.getString("nombre")+"</td>");
                  out.println("<td>"+result.getString("apellido")+"</td>");
                  out.println("<td>"+result.getString("correo")+"</td>");
                  out.println("<td>"+result.getString("contrasena")+"</td>");
                  out.println("<td>"+result.getString("estado_civil")+"</td>");
                  out.println("<td>"+result.getString("telefono")+"</td>");
                  out.println("<td>"+result.getString("cedula")+"</td>");
                  out.println("</tr>");
                }
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between">
              <div class="card-info border rounded p-2 shadow-sm p-3 mb-5">
                <p class="card-text bg-danger rounded p-1 text-light fw-bold">Cantidad</p>
                <div class="d-flex align-items-end mb-2"> 
                  <h4 class="card-title mb-0 me-2" id="cantidad">-----</h4>
                  <small class="text-success">(Aumento)</small>
                </div>
                <small>Análisis de la última semana</small>
              </div>
              <div class="card-icon">
